# modulos/recepcion.py - Versión final con autocompletado y gestión de estados
...
class VentanaRecepcion(ctk.CTkFrame):
    def __init__(self, parent, permisos, on_regresar=None):
        ...
        self.variedad_combo = ttk.Combobox(grid_prod, width=28, values=["ATAULFO", "MANILA", "KENT", "TOMMY", "HADEN"], state="readonly")
        self.variedad_combo.set("ATAULFO")
        self.variedad_combo.grid(row=1, column=1, padx=5, pady=6, sticky="w")
        crear_tooltip(self.variedad_combo, "Variedad del mango")
    ...
    def cargar_recepcion_para_editar_por_id(self, recepcion_id):
        ...
        self.variedad_combo.set(datos[14].title() if datos[14] else "")
